...
Scenario: Validate if the user is able to add education details using external JSON file
	When I enter education details from json file with the TestName "AddEducationDetailsWithValidInput"
	Then I should see the success message 

Scenario: Validate if the user is not able to add the education details with invalid College/University Name
When I enter invalid education details from json file with the TestName "AddEducationDetailsWithInvalidCollegeUniversityName"
Then I should see the error message 

Scenario: Validate if the user is not able to add the education details with invalid Degree
When I enter invalid education details from json file with the TestName "AddEducationDetailsWithInvalidDegree"
Then I should see the error message
...
When I leave either one or all the fields empty and give the data from json file with the TestName "LeaveEitherOneORAllTheFieldsEmpty" 
...
When I enter same education details twice from json file with the TestName "AddSameEducationDetailsMultipleTimes"
...
When I enter education details from json file after the session has expired with the TestName "AddEducationDetailsWhenSessionHasExpired"
